...
def valid_date(date):
    ...
    if date:
        ...
        if datetime.datetime.strptime(date, '%m-%d-%Y') > datetime.datetime.strptime('29-03-2000', '%m-%d-%Y'):
            valid_date = False
    return valid_date
if __name__ == '__main__':
    print(valid_date('15-01-2000'))

A:

I would personally recommend you go with dateutil. It is the recommended Python module for parsing date strings:
>>> from