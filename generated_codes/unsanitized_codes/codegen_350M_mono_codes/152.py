...
def compare(game,guess):
    ...
    #loop thh
    while True:
        #koma nhap guess ke aapkane
        guess = guess.split()[0]
        #guess kiya hai se naad score ko beeche ke se score
        score = compare_two(guess,game)
        #compare score ke return ko return na karo
        return score
    
    """
    Compare karo hai hai yeh aapke nahi, pata ke baad game result karo ke score ke hai. Soi jema nahi.
    """
    
    """
    Cari score ke aap kari.
    """
