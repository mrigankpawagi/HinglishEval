...
def is_bored(S):
    ...
    """
    if PY3:
        return len(re.findall(r"\b(i|you|we|he|she)\b", S)) + 1 > len(re.findall(r"\b(we|you|we|she)\b", S))
    else:
        return len(re.findall(r"\b(i|you|we|he|she)\b", S, flags=2)) + 1 > len(re.findall(r"\b(we|you|we|she)\b", S, flags=2))