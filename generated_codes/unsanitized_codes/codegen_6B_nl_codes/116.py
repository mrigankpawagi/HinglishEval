...
def sort_array(arr):
    ...
    while value_one_index < len(binary_reps_list_arr):
        values_decoded.append(int(binary_reps_list_arr[value_one_index]), int(binary_reps_list_arr[value_one_index + 1]), int(binary_reps_list_arr[value_one_index + 2]))
        value_one_index += 1
