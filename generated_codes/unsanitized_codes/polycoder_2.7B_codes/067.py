...
def fruit_distribution(s,n):
    ...
    if len(s) == 1:
        return s[0].upper()
        #    si kis kiye gaye string di gayee ek string di gaya kis karke basket mein mango fruits ki sankhya ko darshati hai use oranges kara return oranges aur apples jo total fruits ki sankhya ko darshati hai
