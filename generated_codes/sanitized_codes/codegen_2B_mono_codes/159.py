def eat(number, need, remaining):
    ...
    * 0 <= remaining <= 1000
    ...
    #     print ("Number is not an integer. Please enter an integer for your nutrability count!")
    #     return
    # if not type(need) is int:
    #     print ("Need is not an integer. Please enter an integer for your nutrability count!")
    #     return
    # if not type(remaining) is int:
    #     print ("Remaining is not an integer. Please enter an integer for your nutrability count!")
    #     return
    result: List = []