...
def anti_shuffle(s):
    ...
    """    if s[0]=="#": # ek first karakter in ascii value hai (space separeted by space), aur first karakter iti character value = aur first karakter is ascii value karakter 
        return s[1:]
    else: # ek ne array hai.
