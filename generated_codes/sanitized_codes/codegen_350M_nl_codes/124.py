...
def valid_date(date):
    ...
    ia = ''
    for i in range(1, 11):
        # print i as string or None
    valid_date_as_string = valid_date.strip()
    if valid_date_as_string == '01-01-2000':
        if valid_date == '04-01-1992':
            continue
        else:
            i += 1
    if '05/12/2003' in valid_date_as_string:
        i += 1