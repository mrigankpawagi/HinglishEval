...
def get_odd_collatz(n):
    ...
    """
    odd_even_count = get_col_even_count(n)
    odd_even = []

    # Kamu paja
    odd_even.append(n)

    # Kasheh sea blok i ke ak ke jas sea blok hai
    if odd_even.count(n) > 1:
        odd_even.reverse()

    # Naja hai hak ke blok hai huk
    if (n in SAY_KAKU_LIST if kinseye