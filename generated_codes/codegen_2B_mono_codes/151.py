...
# Question 17.
#
#   Write a function, product, which accepts a list and returns the product of all
# the elements in the list.
#
#   For example: product([2, 3, 5])  should return 2*3*5 = 30
#
#   Write a similar function which returns the product of all the non-zero elements
# from the list.
