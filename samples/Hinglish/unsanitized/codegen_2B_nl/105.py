...
# by_length is a function
# we use function call to get array
# we get name and number of number in array
# we use if else for compare and replace
# we use return statement to print replaced name
# ---
