...
def reverse_delete(s,c):
    ...
    if s not in c:
        return
    if s[0] in 'ae' and s[1] in 'ae' and s[2] in 'ae' and c[0] not in 'a' and c[1] not in 'a' and c[2] not in 'a' and c[3] not in 'a' and c[4] not in 'a' and c[5] not in 'a' and c[6] not in 'a' and c[7] not in 'a' and c[8] not in 'a' and c[9] not in 'a' and c[10] not in 'a' and c[11] not in 'a' and c[12] not in 'a' and c[13] not in 'a' and c[14] not in 'a' and c[15] not in 'a':
        return
    c