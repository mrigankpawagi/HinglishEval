...
def solution(lst):
    ...
    """
    if not lst: return 0  # If no list, return 0.
...
print("SOLUTION")
print("===========")
print("SOLUTION VALUE: ", solution([1, 3, 5, 7]))
print("==========")
print("SOLUTION VALUE: ", solution([5, 8, 7, 1]))
print("==========")
print("SOLUTION VALUE: ", solution([3, 3, 3, 3, 3]))