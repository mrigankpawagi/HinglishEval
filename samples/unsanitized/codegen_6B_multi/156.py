...
parser = argparse.ArgumentParser(
    description='Convert number to roman numerals (1-999)',
    formatter_class=argparse.RawTextHelpFormatter
)

parser.add_argument('number',
    type=int_argument,
    help='Roman-numerical number')

# Note: The user can give any type of input for number,
# but only a positive number will