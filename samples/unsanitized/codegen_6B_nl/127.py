...
def intersection(interval1, interval2):
    ...
    # Check intersection length against prime numbers.
    intersect_length_result = False

    # Find intervals intersection length.
    if (interval1_end < interval2_start and interval1_start > interval2_end):
