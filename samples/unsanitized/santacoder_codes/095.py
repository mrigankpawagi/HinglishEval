...
def check_dict_case(dict):
    ...
    lower_keys_list = [x.lower() for x in keys_list]

    #print(lower_keys_list)
    if(len(lower_keys_list)!=len(set(lower_keys_list))):
        return False

    #print(set(lower_keys_list))
    if(True in [x in dict.values() for x in dict.values()]):
        return True
