...
def eat(number, need, remaining):
    ...
    * 0 <= remaining <= 1000
    ...
    # if need in fact equals number
    if need == number:
        return [need] + remaining
    else:
        return eat(need, number - need, remaining) + remaining


# def find_min_element(binary_list):
    # return min(binary_list[0], binary_list[1])
    # return min(binary_list[0], binary_list[1]), binary_list[2]
    # return min(binary_list[0], binary_list[1]), min(binary_list[0], binary_list[1]), binary_list[2]
